...
class TradingCenter:
    ...
    def set_resource_quantity(self, resource, quantity, price):
        if resource == 'food':
            self.__food = [quantity, price]
        elif resource == 'wood':
            self.__wood = [quantity, price]
        elif resource == 'mineral':
            self.__mineral = [quantity, price]
        elif resource == 'leather':
            self.__leather = [quantity, price]
